...
<table className="w-full table-auto border-collapse">
        <thead>
            <tr>
                <th className="border border-gray-400 px-4 py-2 text-left"> student ID</th>
                ...
                <th className="border border-gray-400 px-4 py-2 text-left">Fees Status(Y/N)</th>
        ...
        <tbody>
            {employees.map(employee => (
                <tr key={employee.id}>
                    ...
                    <td className="border px-4 py-2">{employee.Grade}</td>

                    <td className="border px-4 py-2">{employee.FeesStatus}</td>
